...
install:
	...
	@command -v lychee >/dev/null 2>&1 || { command -v cargo >/dev/null 2>&1 && { echo "Installing lychee..."; cargo install lychee; } || { echo "Install cargo to be able to install lychee"; exit 1; } }
